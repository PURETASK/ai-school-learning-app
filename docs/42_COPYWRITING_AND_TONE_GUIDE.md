# Copywriting and Tone Guide

## Purpose

Define how the app speaks to students, parents, and teachers.
...
- Emphasize ownership, evidence, portfolio, career readiness.

## Parent Copy Rules

- Explain progress plainly.
...
Here is the correct thinking step.
Try this next.
```
...
- Fear-based wording
- Fake hype
- Overly cute language for older students
...
- Define student, parent, teacher, error, feedback, and reward copy rules by age band.
