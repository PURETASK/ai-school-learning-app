...
Define the platform name, academy names, positioning, and messaging.
...
```txt
[Platform Name] is a K–12 learning platform that helps students master school subjects while learning how to think through first-principles problem solving, critical thinking, evidence-based reasoning, discussion, interpretation, and spaced retention.
```
...
Do not hardcode final brand assets until naming is locked.
...
- Define naming criteria, academy identity rules, and positioning against passive ed-tech.
