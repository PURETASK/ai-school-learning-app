...
Define how quiz and practice questions are structured.
...
- Distractors should reflect common mistakes.
- Some questions should require reasoning, not recall only.
- Retrieval questions should be reusable in Memory Vault.

## Implementation Notes

- Keep question bank separate from UI.
- Support randomization later.
...
- Define question types, difficulty, skill tags, answer explanations, distractor rationale, and validation.
