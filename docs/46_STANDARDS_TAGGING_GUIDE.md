# Standards Tagging Guide

## Purpose

Define how curriculum files use standards tags consistently.

## Tag Philosophy

Tags should support searching, reporting, alignment, and future state-specific mapping.
...
MATH.G3.MULTIPLICATION.ARRAYS
MATH.G6.RATIOS.EQUIVALENT_RATIOS
...
- Every quiz question should map to a skill or standard.
- Tags should be stable and machine-readable.
- Do not encode long descriptions inside tags.

## Implementation Notes

- Store tag metadata in a separate standards file later.
- Validate lesson tags with a script.
...
- Define standards tag syntax, validation, subject namespaces, and mapping rules.
