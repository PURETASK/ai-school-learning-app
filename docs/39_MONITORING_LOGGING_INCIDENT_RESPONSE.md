...
Define how the app observes errors and handles problems safely.

## Logging Philosophy

Logs should help debug the system without exposing sensitive student information.
...
- Timestamp
- Non-sensitive IDs when necessary
- System event status

## Do Not Log

- Full student personal information
- Private messages
- Sensitive profile fields
- Raw essay content unless explicitly needed and protected
...
## Incident Response Later

1. Identify issue.
2. Stop data exposure if any.
3. Preserve necessary logs.
4. Notify required stakeholders if needed.
5. Patch.
6. Review root cause.

## Implementation Notes for Codex

- Use safe error utilities.
- Avoid console logging sensitive values.
- Add monitoring tools later after deployment target is chosen.
...
- Define logs, metrics, incident severity, response checklist, and privacy-safe monitoring.
