...
Define how curriculum content is reviewed before it becomes usable in the app.

## Content QA Philosophy

No lesson should be treated as production-ready until it passes academic, safety, accessibility, and technical checks.
...
2. Internal review
3. Standards check
4. Thinking-pillar check
5. Accessibility check
6. Age-appropriateness check
7. Assessment check
8. Technical schema validation
9. Approved
10. Published
...
- Connected to unit
- Standards tags present
- Thinking skill tags present
- Retrieval check included
- Spaced review item included
- Feedback rules included
- No unsafe content
- Accessible language
- No answer-only AI tutor behavior
...
- Include content status in lesson schema.
- Build validation scripts before large curriculum import.
- Keep approval workflow simple in MVP.
...
- Content must pass factual, standards, pedagogy, accessibility, safety, and schema checks before publish.
