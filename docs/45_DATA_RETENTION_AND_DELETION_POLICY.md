...
Define how long student data is kept and how deletion/export should work later.
...
- Keep demo data safe and fake.
- Do not build permanent retention assumptions into code.

## Later User Rights Features

- Parent can request export.
- Parent can request deletion.
- School admin can manage school-linked data according to policy.

## Deletion Considerations

- Delete or anonymize student profile.
- Remove parent-child link.
- Remove or anonymize progress records.
- Preserve aggregate metrics only if non-identifying and policy allows.

## Implementation Notes

- Add timestamps to key records.
- Do not rely on hard deletes only without policy review.
...
- Define retention periods, deletion requests, exports, logs, and backups.
