...
Define reusable rubrics for writing, projects, discussion, evidence reasoning, interpretation, and problem solving.

## MVP Rubrics

### Evidence-Based Response Rubric
...
- Rubrics should be data, not hardcoded UI text.
- Rubric scores should support parent/teacher reports.
...
- Define rubrics for explanation, evidence, interpretation, discussion, projects, and writing.
