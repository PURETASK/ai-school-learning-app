# Project and Capstone Library

## Purpose

Define projects that let students apply learning in real outputs.

## Project Philosophy

Projects should connect academic content to meaningful creation, explanation, design, or investigation.
...
- Investigate a local environmental problem.
- Build a ratio recipe project.
...
- Projects are phase 2 for full support, but schema should exist early.
...
- Define project templates, capstone structure, rubrics, portfolio artifacts, and age bands.
