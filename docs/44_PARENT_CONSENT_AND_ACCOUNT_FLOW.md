# Parent Consent and Account Flow

## Purpose

Define how parent/guardian accounts and student access should work, especially for younger users.

## MVP Flow

1. Parent creates account.
2. Parent creates student profile.
3. Parent selects grade.
4. Student gets learning access.
5. Parent can view progress.

## Student Login Options

MVP options to consider:

- Parent-managed login
- Student PIN under parent account
- Separate student account later

## Consent Philosophy

For children, parent/guardian should control account creation and access where appropriate.

## Required Controls

- Parent can view linked child progress.
- Parent can update student profile.
- Parent can request deletion later.
- Parent can manage communication settings later.

## Avoid

- Asking children for unnecessary contact information.
- Public usernames.
- Social discovery.
- Open messaging.
...
- Keep parent and student profiles separate.
- Design data model for multiple children per parent.
...
- Define parent consent/account linking flow and blocked states if consent is missing.
