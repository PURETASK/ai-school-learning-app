...
export function normalizedAiTutorEventRow(row = {}) {
  ...
  return {
    ...
    providerUsage: toObject(row.provider_usage),
    providerModeration: toObject(row.provider_moderation),
    providerReview: toObject(row.provider_review),
    providerAttemptStatus: row.provider_attempt_status || "",
    providerAttemptNumber: Number(row.provider_attempt_number || 0),
    providerAttemptedAt: row.provider_attempted_at || "",
    providerAttemptHistory: toArray(row.provider_attempt_history),
    providerAttachedAt: row.provider_attached_at || "",
